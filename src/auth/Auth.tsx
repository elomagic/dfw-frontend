...
export enum Role {
    ...
    LICENSE_PERMITTED_CREATE = "LICENSE_PERMITTED_CREATE",
    LICENSE_PERMITTED_READ = "LICENSE_PERMITTED_READ",
    LICENSE_PERMITTED_UPDATE = "LICENSE_PERMITTED_UPDATE",
    LICENSE_PERMITTED_DELETE = "LICENSE_PERMITTED_DELETE",
...
export const AuthProvider = (authProvider: AuthProviderProps): JSX.Element => {
    ...
    const getAuthBaseUrl = (): string => {
        const url = import.meta.env.DEV ? import.meta.env.VITE_AUTH_URL : window.location.host;
